# Repeat the process: read, name and subset the power consumption dataset:
...
#Constructing the plot and saving to PNG file.
...
title(main="Plot2 Global Active Power Vs Time")
dev.off()